...
The project is based on Kaggle dataset “Credit Card Transactions Fraud Detection Dataset'' a **Credit Card Transactions generated using Sparkov, containing ~1 million transactions**. 
